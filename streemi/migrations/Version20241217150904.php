 ...
 */
final class Version20241217150904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_media (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE category_media_category ADD CONSTRAINT FK_E83D744E5DE5590E FOREIGN KEY (category_media_id) REFERENCES category_media (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE media ADD CONSTRAINT FK_6A2CA10C5DE5590E FOREIGN KEY (category_media_id) REFERENCES category_media (id)');
